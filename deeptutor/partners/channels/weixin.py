...
class WeixinChannel(BaseChannel):
    ...
    def _get_state_dir(self) -> Path:
        ...
        if self.config.state_dir:
            ...
            d = get_partner_runtime_subdir(self.partner_id, "weixin", owner_id=self.owner_id)
    ...
    async def _download_media_item(
        ...
        try:
            ...
            media_dir = get_partner_media_dir(self.partner_id, "weixin", owner_id=self.owner_id)
