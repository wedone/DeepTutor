...
def ensure_partner_workspace(partner_id: str, *, owner_id: str = "") -> Path:
...
def _partner_path_service(partner_id: str, *, owner_id: str = "") -> PathService:
...
def soul_path(partner_id: str, *, owner_id: str = "") -> Path:
    return _partner_path_service(partner_id, owner_id=owner_id).get_workspace_dir() / SOUL_FILENAME


def read_soul(partner_id: str, *, owner_id: str = "") -> str:
...
def write_soul(partner_id: str, content: str, *, owner_id: str = "") -> None:
    path = soul_path(partner_id, owner_id=owner_id)
...
def _copy_skill(skill_name: str, partner_id: str, *, owner_id: str = "") -> str:
...
def _copy_notebook(notebook_id: str, partner_id: str, *, owner_id: str = "") -> str:
...
def list_assets(partner_id: str, *, owner_id: str = "") -> dict[str, list[dict[str, Any]]]:
    root = ensure_partner_workspace(partner_id, owner_id=owner_id)
...
def remove_asset(partner_id: str, asset_type: str, name: str, *, owner_id: str = "") -> bool:
    root = ensure_partner_workspace(partner_id, owner_id=owner_id)
    service = _partner_path_service(partner_id, owner_id=owner_id)
